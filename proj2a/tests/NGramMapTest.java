...
public class NGramMapTest {
    ...
    @Test
    public void testonsummeWeightHostory() {
        NGramMap ngm = new NGramMap("./data/ngrams/very_short.csv","./data/ngrams/total_counts.csv");
        List<String> Ar = new ArrayList<>();
        Ar.add("airport");
        Ar.add("request");
        TimeSeries Arweight = ngm.summedWeightHistory(Ar, 2007,2008);

        double expectedvalueAr2007 = (175702.0 + 697645.0)/28307904288.0;
        assertThat(Arweight.get(2007)).isWithin(1E-10).of(expectedvalueAr2007);
    }
